...
import {PartnerListModalComponent} from './partner-list-modal/partner-list-modal.component';
...
@Component({
    selector: 'ngx-partner-list-render',
    template: `
...
export class PartnerListCustomRenderComponent implements ViewCell, OnInit {
    ...
    view() {
        const activeModal = this.modalService.open(PartnerListModalComponent, {
            size: 'lg',
            backdrop: 'static',
            container: 'nb-layout',
    ...
    edit() {
        ...
        activeModal.componentInstance.modalHeader = '编辑合伙人';
