...
import {PartnerListCustomRenderComponent} from './custom-render-component';
...
export class PartnerListComponent implements OnInit {
    ...
    settings = {
        columns: {
            ...
            operate: {
                title: '操作',
                type: 'custom',
                renderComponent: PartnerListCustomRenderComponent,
    ...
    onSubmit(f: NgForm, opt) {
        ...
        if (temp.teamProfitLower) {
            sendData['teamProfitLower'] = temp.teamProfitLower;
        }
        if (temp.teamProfitUpper) {
            sendData['teamProfitUpper'] = temp.teamProfitUpper;
        }
        if (temp.userIdLike) {
        ...
        if (opt === 'search') {
            if (JSON.stringify(sendData) !== '{}') {
                sendData['action'] = 'searchPartnerUser';
            ...
            sendData['action'] = 'outputPartnerUser';
