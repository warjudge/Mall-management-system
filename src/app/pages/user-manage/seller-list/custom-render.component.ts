...
import {SellerListModalComponent} from './seller-list-modal/seller-list-modal.component';
import {DataService} from '../../../service/dataService';
import {NbDialogService,} from '@nebular/theme';
import {ToastrService} from 'ngx-toastr';

@Component({
    selector: 'ngx-seller-list-render',
    template: `
...
export class SellListCustomRenderComponent implements ViewCell, OnInit {
    ...
    view() {
        const activeModal = this.modalService.open(SellerListModalComponent, {
            size: 'lg',
            backdrop: 'static',
            container: 'nb-layout',
        ...
        activeModal.componentInstance.modalHeader = '商家信息';
    ...
    edit() {
        ...
        activeModal.componentInstance.modalHeader = '编辑商家';
