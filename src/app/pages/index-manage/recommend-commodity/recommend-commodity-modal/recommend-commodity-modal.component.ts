...
@Component({
    selector: 'ngx-recommend-commodity-modal',
    templateUrl: './recommend-commodity-modal.component.html',
    styleUrls: ['./recommend-commodity-modal.component.scss'],
})
export class RecommendCommodityModalComponent implements OnInit {
