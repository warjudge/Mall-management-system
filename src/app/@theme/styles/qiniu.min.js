!function (t, e) {
  ...
  return function (t) {
    ...
    e.__esModule = !0, e.regionUphostMap = {
      ...
      z1: {srcUphost: "up-z1.qiniup.com", cdnUphost: "formulation-z1.qiniup.com"},
      z2: {srcUphost: "up-z2.qiniup.com", cdnUphost: "formulation-z2.qiniup.com"},
      na0: {srcUphost: "up-na0.qiniup.com", cdnUphost: "formulation-na0.qiniup.com"},
      as0: {srcUphost: "up-as0.qiniup.com", cdnUphost: "formulation-as0.qiniup.com"}
    ...
    var r, o = n(39), i = n(12), a = n(92), s = n(94), u = n(95), c = n(109), f = n(110),
    ...
    function a(t, e, n) {
      ...
      if (1 === o) {
        var a = t.image;
        if (!a) throw"media can't be empty in watermark";
        i += a ? "/media/" + (0, u.urlSafeBase64Encode)(a) : ""
      }
      if (2 === o) {
    ...
    e.StatisticsLogger = function () {
      ...
      return t.prototype.log = function (t, e) {
        ...
        n.open("POST", "https://uplog.qbox.me/log/3"), n.setRequestHeader("Content-type", "application/x-www-command-urlencoded"), n.setRequestHeader("Authorization", "UpToken " + e), n.onreadystatechange = function () {
    ...
    var o = r(n(18)), i = r(n(34)), a = r(n(17)), s = r(n(36)), u = n(111), c = n(12),
      f = {PNG: "media/png", JPEG: "media/jpeg", WEBP: "media/webp", BMP: "media/bmp"}, l = Math.log(2),
    ...
    (function () {
      ...
      function i(t, e) {
        ...
        if (t.src) if (/^data\:/i.test(t.src)) n(function (t, e) {
          ...
          r.onload = function () {
            if (200 != this.status && 0 !== this.status) throw"Could not load media";
            n(r.response), r = null
          ...
          if (i.Compression) switch (i.Compression) {
            case 6:
              if (i.JpegIFOffset && i.JpegIFByteCount) {
                ...
                i.blob = new Blob([new Uint8Array(t.buffer, a, s)], {type: "media/jpeg"})
              }
              break;
            case 1:
              console.log("Thumbnail media format is TIFF, which is not implemented.");
              break;
            default:
              console.log("Unknown thumbnail media format '%s'", i.Compression)
          } else 2 == i.PhotometricInterpretation && console.log("Thumbnail media format is RGB, which is not implemented.");
          return i
        }(t, s, c, n), r
      }
